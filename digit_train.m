...
load data_train
if ~exist('data','var')
    error('La variabile "data" non e'' presente in data_train.mat');
end

labels = data(:,1);
num_samples = size(data,1);
y = zeros(10,num_samples); %Correct outputs vector
for i = 1:num_samples
    y(labels(i)+1,i) = 1;
end
...
% ind=60000;
% I1=images(:,ind);
% I2=reshape(I1,[28 28]); imshow(I2'), title(sprintf('%d',labels(ind)));
